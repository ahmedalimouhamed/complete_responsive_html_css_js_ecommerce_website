...
function toggle(e){
    e.preventDefault();
    submenu.forEach((item) => item != this 
...
var productThumb = new Swiper(".smapp-image", {
    loop: true,
    spaceBetween: 10,
    slidesPerView: 3,
    freeMode: true,
...
window.onload = function(){
    document.querySelector(".site.page-checkout").classList.toggle("showmodal");
}

document.querySelector(".modalclose").addEventListener("click", () => {
    document.querySelector(".site.page-checkout").classList.remove("showmodal");
})